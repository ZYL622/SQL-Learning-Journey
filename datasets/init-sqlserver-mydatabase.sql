...
Script Purpose:
    ...
    If the database already exists, it will be dropped to ensure a clean setup. 
...
WARNING:
    Running this script will drop the entire 'MyDatabase' database if it exists, 
        permanently deleting all data within it. 
    Proceed with caution and ensure you have proper backups before executing this script.
*/
